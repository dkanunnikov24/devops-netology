...
● node_exporter.service - Prometheus exporter for hardware and OS metrics
     ...
     Active: active (running) since Sat 2022-03-17 16:09:43 UTC; 21h ago
...
dmesg сообщает:  
```
[Fri Mar 16 13:32:53 2022] cgroup: fork rejected by pids controller in /user.slice/user-1000.slice/session-3.scope
```
